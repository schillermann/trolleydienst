...
$placeholder['shift_history_error_list'] = array();
$placeholder['shift_history_success_list'] = array();
...
if(isset($shift_history_list['success']))
    $placeholder['shift_history_success_list'] = $shift_history_list['success'];
