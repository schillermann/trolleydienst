	...
	<form method="post">
		<fieldset>
			...
			<div>
				...
				<input id="time_from" type="time" name="time_from" tabindex="4" required value="<?php echo (isset($_POST['time_from']))? $_POST['time_from'] : '';?>">
			</div>
			<div>
				<label for="book">Bücher <small>(Pflichtfeld)</small></label>
				<input id="book" type="number" name="book" tabindex="5" value="<?php echo (isset($_POST['book']))? (int)$_POST['book'] : 0;?>">
			</div>
			<div>
				<label for="brochure">Broschüren <small>(Pflichtfeld)</small></label>
				<input id="brochure" type="number" name="brochure" tabindex="6" value="<?php echo (isset($_POST['brochure']))? (int)$_POST['brochure'] : 0;?>">
			</div>
			<div>
				<label for="bible">Bibeln <small>(Pflichtfeld)</small></label>
				<input id="bible" type="number" name="bible" tabindex="7" value="<?php echo (isset($_POST['bible']))? (int)$_POST['bible'] : 0;?>">
			</div>
			<div>
				<label for="magazine">Zeitschriften <small>(Pflichtfeld)</small></label>
				<input id="magazine" type="number" name="magazine" tabindex="8" value="<?php echo (isset($_POST['magazine']))? (int)$_POST['magazine'] : 0;?>">
			</div>
			<div>
				<label for="tract">Traktate <small>(Pflichtfeld)</small></label>
				<input id="tract" type="number" name="tract" tabindex="9" value="<?php echo (isset($_POST['tract']))? (int)$_POST['tract'] : 0;?>">
			</div>
			<div>
				<label for="address">Adressen <small>(Pflichtfeld)</small></label>
				<input id="address" type="number" name="address" tabindex="10" value="<?php echo (isset($_POST['address']))? (int)$_POST['address'] : 0;?>">
			</div>
			<div>
				<label for="talk">Gespräche <small>(Pflichtfeld)</small></label>
				<input id="talk" type="number" name="talk" tabindex="11" value="<?php echo (isset($_POST['talk']))? (int)$_POST['talk'] : 0;?>">
			</div>
			<div>
				<label for="note">Bemerkung</label>
				<textarea id="note" name="note" class="note" tabindex="12"><?php echo (isset($_POST['note']))? $_POST['note'] : '';?></textarea>
			</div>
		</fieldset>
		<div class="from-button">
			<button name="save" class="active" tabindex="13">
