	...
	<form method="post">
		<fieldset>
			...
			<div>
				...
				<input id="template_email_subject" name="template_email_subject" class="email-subject" tabindex="1" required value="<?php echo $placeholder['selected_template']['subject']; ?>">
			</div>
			<div>
				<label for="template_email_message">Nachricht <small>(Pflichtfeld)</small></label>
				<textarea id="template_email_message" name="template_email_message" tabindex="2" rows="20" required><?php echo $placeholder['selected_template']['message'];?></textarea>
			</div>
			<div>
		...
		<div class="from-button">
			<button name="save" class="active" tabindex="3">
